export default {
  ...
  room: {
    ...
    members: '房间成员',
    host: '房主',
    reconnectingMember: '重连中',
    created: '房间已创建',
    joined: '已加入房间',
    left: '已离开房间',
    dissolved: '房间已解散',
    kicked: '你已被踢出房间',
    kickedMember: '已将 {name} 踢出房间',
    transferred: '已将房主转让给 {name}',
    becameHost: '你已成为房主',
    enterCode: '请输入房间号',
    ...
    confirmCancel: '取消',
    confirmOk: '确定',
    confirmKick: '将 {name} 踢出房间？对方仍可凭房间号重新加入。',
    confirmTransfer: '将房主转让给 {name}？',
    confirmDissolve: '解散房间后所有成员都将退出，且无法恢复。确定解散？',
  },
